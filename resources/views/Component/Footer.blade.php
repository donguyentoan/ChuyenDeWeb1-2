<footer class="text-gray-600 body-font bg-[#006a31] w-full">
    ...
    <a href="#" id="scrollButton"
        class="fixed bottom-[95px] z-50  right-7 p-3 bg-[#67b868] hover:bg-[#ff6b29] text-white rounded-full focus:outline-none transition ">
    ...
    <button id="scrollButton"
        class="fixed bottom-[160px] z-50 notification-icon right-7 p-3 bg-[#67b868] hover:bg-[#ff6b29] text-white rounded-full focus:outline-none transition ">
        <a href="tel:0344842232"><svg class="w-8 h-8 bi bi-telephone" xmlns="http://www.w3.org/2000/svg" width="16"
    ...
    <button id="scrollButton"
        class="fixed bottom-[230px] z-50 notification-icon right-7 p-3 bg-[#67b868] hover:bg-[#ff6b29] text-white rounded-full focus:outline-none transition ">
        <a href="https://www.facebook.com/100009053365697"> <svg class="w-8 h-8 bi bi-chat-left-dots"
