<header class="text-gray-600 body-font w-screen">
    ...
    <nav class="md:w-11/12 overflow-x-auto w-full mx-auto py-2 mb-3 bg-[#00603c] md:rounded-xl md:ml-auto flex items-center text-white flex-row flex md:text-base text-sm ">
      ...
      <a href="categories/{{$category->id}}" class="mr-5 ml-5 hover:text-gray-900">{{ $category->name }}</a>
      @endforeach
        ...
        <div class="icon_cart ml-auto mr-20 group">
            ...
            <!-- Trong blade template -->
                  <div class="text-black minicart bg-white p-4 w-72 mx-auto mt-1 rounded-lg shadow-lg z-50 absolute right-[5%]  hidden group-hover:block">
                    ...
                    <ul class="minicart">
                      ...
                      <div>
                        ...
                        <a href="/cart"><input type="button" value="View Cart Details" class="w-full h-10 font-semibold bg-black text-white border-none cursor-pointer hover:bg-gray-800">
                      </div></a>
