    ...
    <section class="text-gray-600 body-font bg-green-100 " >
        <div class="container px-5  py-24 mx-auto flex flex-wrap ">
                ...
                <div class="rounded-lg flex flex-col md:ml-auto w-full mt-10 md:mt-0 mb-5">
                    <div
                        ...
                        <div class="relative flex-grow w-full">
                            <label for="full-name" class="leading-7 font-bold text-sm text-gray-600">Full Name &#8727;   </label>
                    ...
                    <div
                        class="flex lg:w-2/3 mt-8 w-full sm:flex-row  flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
                    ...
                    <div
                        ...
                        <div class="relative flex-grow w-full">
                            ...
                            <input type="text" id="content" name="content"
                                class="w-full bg-gray-100 h-40 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                placeholder="Enter the enquiry...">
                        </div>

                    </div>
                <div
                        class="flex lg:w-2/3 mt-8 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 text-left"></div>
            ...
            <div class="lg:w-1/3 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                <img alt="hinhanhlienhe" class="object-cover object-center h-full w-full"
                    src="https://thepizzacompany.vn/Themes/Emporium/Content/img/hinh-lien-he-3.jpg">
            </div>
        </div>
    </section>
