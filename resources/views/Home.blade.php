        ...
        <dialog id="firstModal" class="p-10 border-2 border-gray-300 rounded-xl w-11/12 h-4/5 mx-auto relative">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div id="remove_hidden" class="remove_hidden">
                        <p class="text-[#007d43]">Kích thước nhỏ 6``</p>
                        <p class="leading-relaxed text-base mb-3">Tôm, Đào hoà quyện bùng nổ cùng sốt Thousand
                            Island</p>
                        ...
                        <div class="size">
                            ...
                            <label class="pr-3">
                                <input type="radio" class="size" name="size" value="medium" data-price="100000">
                                Size trung bình (+$2)
                            </label>
                            <label class="pr-3">
                                <input type="radio" class="size" name="size" value="large" data-price="200000"> Size
                                lớn (+$4)
                            </label>
                        </div>
                        ...
                        <div class="toppng">
                            ...
                            <label class="pr-2">
                                <input type="checkbox" class="topping" value="Mỏng Giòn" data-topping="105"> Mỏng
                                giòn
                            </label>
                            <label class="pr-2">
                                <input type="checkbox" class="topping" value="Viền Phô Mai" data-topping="110"> Viền
                                phô mai
                            </label>
                            <label class="pr-2">
