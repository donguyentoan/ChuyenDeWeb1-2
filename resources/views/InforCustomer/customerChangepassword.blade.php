                            ...
                            <table class="rounded-lg w-full">
                                <form action="/changepassword" method="post">
                                    ...
                                    <label class="block py-2">
                                        <span class="after:content-['*'] py-2 after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 font-extrabold text-xl">
                                            Mật khẩu cũ:
                                        </span>
                                        <input type="password" name="password" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Mật khẩu cũ:" />
                                    ...
                                    <label class="block py-2">
                                        ...
                                        <input type="password" name="password_new" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Mật khẩu mới:" />
                                       
                                    </label> @if($errors->has('password_new'))
                                        <div class="alert alert-danger  text-red-500">{{ $errors->first('password_new') }}</div>
                                        @endif
                                    <label class="block py-2">
                                        <span class="after:content-['*'] py-2 after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700 font-extrabold text-xl">
                                            Nhập lại mật khẩu mới:
                                        </span>
                                        <input type="password" name="password_new_confirmation" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Nhập lại mật khẩu mới:" />
                                      
                                    </label>  @if($errors->has('password_new_confirmation'))
                                        <div class="alert alert-danger  text-red-500">{{ $errors->first('password_new_confirmation') }}</div>
                                        @endif
