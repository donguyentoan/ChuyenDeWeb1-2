                ...
                <div class="rounded-lg border-2 shadow-lg h-full ">
                    <div class="px-8 py-4">
                        ...
                        <div class="py-2">
                            ...
                            <br>56, Đường số 2, Phường Trường Thọ, Quận Thủ Đức, Thành Phố Hồ Chí Minh, Việt Nam
                        </div>
                        <strong>
                            Điện thoại
                        </strong>
                ...
                <div class="rounded-lg border-2 shadow-lg  h-full">
                    <div class="px-8 py-4">
                        ...
                        <div class="py-2">
                            ...
                            <br><a href="#" class="text-green-400">Đang chờ xử lý</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex p-4">
                    <div class="w-8/12 md:flex container">
                        <div class=" md:w-3/12 text-center">
                            <img src="anhpizza.png" alt="">
                        </div>
                        <div class=" md:w-5/12">
                            <strong class="">Pizza tôm Cocktail</strong>
                            <br>Kích thước - Nhỏ 6"
                            <br>Đế - Dày
                        </div>
                    </div>
