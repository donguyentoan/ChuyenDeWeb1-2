                ...
                <div>
                    ...
                    <div class=" m-3  shadow-2xl rounded-xl  ">
                        <div class="box1 bg-white w-full  rounded-xl">
                            ...
                            <textarea class="mx-3 border-[1px] border-black-500" name="" id="" cols="50" rows="5" placeholder="Nội dung....."></textarea>
                    ...
                    <div class=" m-3  shadow-2xl rounded-xl  ">
                        ...
                        <form action="/checkout/receivingIformation" method="get">
                            <div class="box-item">
                            ...
                            <div class="ml-3 p-2 py-5 flex justify-end">
                                <input type="hidden" id="totalOrder" name="totalOrder" value="">
                                <input type="submit" class="bg-gradient-to-r from-cyan-500 to-blue-500 px-20 py-2 rounded-lg  " value="Quay Về">
                                <input type="submit" class="bg-gradient-to-r from-cyan-500 to-blue-500 px-20 py-2 rounded-lg ml-2 " value="Thanh Toán">
                            </div>
                        </form>
