            ...
            <nav aria-label="Main" class="flex-1  py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: true, open: true}">
                ...
                >
                  ...
                  <span class="ml-2 text-sm text-white font-bold"> Dashboards </span>
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                  ...
                  <a
                    href="index.html"
                    role="menuitem"
                    class="block p-2 font-bold text-sm text-white transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700"
                  >
                    Default
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm text-white font-bold"> Pages </span>
                  <span aria-hidden="true" class="ml-auto">
                    <!-- active class 'rotate-180' -->
                    <svg
                      class="w-4 h-4 transition-transform transform"
